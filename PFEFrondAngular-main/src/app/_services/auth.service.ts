...
const AUTH_API = 'http://localhost:8080/api/auth/loginUser';
const AUTH_API2 = 'http://localhost:8080/api/auth/registerUser';
const AUTH_API3 = 'http://localhost:8080/api/auth/registerDelivery';
const AUTH_API4 = 'http://localhost:8080/api/auth/SousAdmin';
