...
const AUTH_API6 = 'http://localhost:8080/api/auth/caisseListVendor';
const AUTH_API7 = 'http://localhost:8080/api/auth/cancelOrderByVendor';
const AUTH_API8 = 'http://localhost:8080/api/auth/AcceptOrderByVendor';
const AUTH_API9 = 'http://localhost:8080/api/auth/cancelOrderByClient';
