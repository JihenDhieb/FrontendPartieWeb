...
const baseURL ="http://localhost:8080/User/edit";
const baseURL3="http://localhost:8080/User";
const baseURL4="http://localhost:8080/User/email";


const baseURL5="http://localhost:8080/User/todayRevenue";
const baseURL6="http://localhost:8080/User/weekRevenue";
const baseURL7 ="http://localhost:8080/User/monthRevenue";
const baseURL8 ="http://localhost:8080/caisse/todaySales";
const baseURL9 ="http://localhost:8080/caisse/totalSales";
...
const  baseURL18="http://localhost:8080/User/VendeurTodayR";
...
export class UserServiceService {
  ...
  private const  ="http://localhost:8080/User/listeUser";
  private const2  ="http://localhost:8080/caisse/AdminTotalRevenu";
  private const3  ="http://localhost:8080/caisse/AdminRevenu";
