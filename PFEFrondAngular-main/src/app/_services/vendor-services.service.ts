...
export class VendorServicesService {
  ...
  private apiUrl3 = 'http://localhost:8080/article/addArticle';
  private apiUrl4 = 'http://localhost:8080/pages/editPage';
  private apiUrl5= 'http://localhost:8080/pages/delete';
  private apiUrl6= 'http://localhost:8080/article/editArticle';
  private apiUrl7= 'http://localhost:8080/article/deleteArticle';
  private apiUrl8= 'http://localhost:8080/article/getarticle';
  private apiUrl9= 'http://localhost:8080/article/ListeArticle';
  private apiUrl10= 'http://localhost:8080/article/findArticlesByPage';
  private apiUrl11= 'http://localhost:8080/article/articlesLocal';
